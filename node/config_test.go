...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gosc.ipc", false, filepath.Join(os.TempDir(), "gosc.ipc")},
		{"data", "gosc.ipc", false, "data/gosc.ipc"},
		{"data", "./gosc.ipc", false, "./gosc.ipc"},
		{"data", "/gosc.ipc", false, "/gosc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gosc.ipc", true, `\\.\pipe\gosc.ipc`},
		{"data", "gosc.ipc", true, `\\.\pipe\gosc.ipc`},
		{"data", `\\.\pipe\gosc.ipc`, true, `\\.\pipe\gosc.ipc`},
	}
