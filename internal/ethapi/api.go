...
import (
	...
	"github.com/offsetcoin/OFFSETCOIN/accounts/scwallet"
	"github.com/offsetcoin/OFFSETCOIN/common"
	"github.com/offsetcoin/OFFSETCOIN/common/hexutil"
	"github.com/offsetcoin/OFFSETCOIN/common/math"
...
//
// https://github.com/offsetcoin/OFFSETCOIN/wiki/Management-APIs#personal_sign
...
//
// https://github.com/offsetcoin/OFFSETCOIN/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != crypto.SignatureLength {
		return common.Address{}, fmt.Errorf("signature must be %d bytes long", crypto.SignatureLength)
	}
	if sig[crypto.RecoveryIDOffset] != 27 && sig[crypto.RecoveryIDOffset] != 28 {
		return common.Address{}, fmt.Errorf("invalid OffSetCoin signature (V is not 27 or 28)")
	}
