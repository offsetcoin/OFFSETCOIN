...
import (
	...
	"github.com/offsetcoin/OFFSETCOIN/internal/web3ext"
...
// Welcome show summary of current Gosc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gosc JavaScript console!\n\n"
